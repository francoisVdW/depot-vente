...
<div class="deposits index content">
    ...
    <?= $this->element('search_frm',['controls' => [
        'id' => ['label' => 'N°', 'placeholder'=> 'Numéro du dépôt'],
        'title' => ['label' => 'Nom', 'placeholder'=> 'Nom du déposant'],
    ]]) ?>
    <table class="table table-striped">
        <thead>
            <tr>
                <th>&nbsp;</th>
                <th style="width: 30px"><?= $this->Paginator->sort('id', 'N°') ?></th>
                <th><?= $this->Paginator->sort('title', 'Déposant') ?></th>
                <th><?= $this->Paginator->sort('phone', 'tél.') ?></th>
                <th><?= $this->Paginator->sort('email','e-mail') ?></th>
                <th>Articles</th>
                <th><?= $this->Paginator->sort('creator_title', 'Auteur') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="font-size: 90%"><?= h($deposit->creator_title) ?></td>
